            ...
            <div class="col-12 col-xl-12">
                <div class="px-0 col-12">
                    <div class="border-0 shadow card">
                        <div class="card-body">
                            <h2 class="mb-1 fs-5 fw-bold mb-3">{{ __('Semua User Rumah Sakit') }}</h2>
                            <div class="row mb-4">
                                <div class="col d-flex justify-content-end">
                                    <a href="{{ route('user-rs.create') }}" wire:navigate
                                        class="btn btn-success text-white"><i class="fas fa-plus"></i>
                                        {{ __('Tambah User Rumah Sakit') }}</a>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-lg-6">
                                        ...
                                        <table class="table striped-table text-black text-center">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="{{ route('user-rs.edit', $user->userId) }}"
...
<script>
    window.addEventListener('delete-confirmation', event => {
            Swal.fire({
                ...
                text: "User Rumah Sakit ini akan terhapus permanen!",
                icon: "warning",
