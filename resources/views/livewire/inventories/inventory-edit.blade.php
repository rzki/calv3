            ...
            <div class="col-12 col-xl-12">
                <div class="px-0 col-12">
                    <div class="border-0 shadow card">
                        <div class="card-body">
                            <h2 class="mb-1 fs-5 fw-bold mb-5">{{ __('Ubah Inventaris') }}</h2>
                            <div class="row mb-5">
                                <div class="col">
                            ...
                            <div class="row">
                                <div class="col">
                                    <form wire:submit='update' method="post">
                                        <div class="row">
                                            <div class="col-lg-3">
                                                <div class="form-group mb-3">
                                                    <label for="nama" class="form-label text-capitalize">{{ __('nama
                                                        alat') }}</label>
                                            ...
                                            <div class="col-lg-3">
                                                <div class="form-group mb-3">
                                                    <label for="merk" class="form-label text-capitalize">{{ __('merk')
                                                        }}</label>
                                            ...
                                            <div class="col-lg-3">
                                                <div class="form-group mb-3">
                                                    <label for="tipe" class="form-label text-capitalize">{{ __('tipe')
                                                        }}</label>
                                            ...
                                            <div class="col-lg-3">
                                                <div class="form-group mb-3">
                                                    <label for="sn" class="form-label text-capitalize">{{ __('serial
                                                        number') }}</label>
                                            ...
                                            <div class="col-lg-3">
                                                <div class="form-group mb-3">
                                                    <label for="tahun" class="form-label text-capitalize">{{ __('tahun
                                                        pengadaan') }}</label>
                                            ...
                                            <div class="col-lg-3">
                                                <div class="form-group mb-3">
                                                    <label for="no_inv" class="form-label text-capitalize">{{ __('no.
                                                        inventaris') }}</label>
                                            ...
                                            <div class="col-lg-3">
                                                <div class="form-group mb-3">
                                                    <label for="kalibrasi_terakhir"
                                                        class="form-label text-capitalize">{{ __('kalibrasi terakhir')
                                                        }}</label>
                                                    <input type="date" class="form-control"
                                                        wire:model='kalibrasi_terakhir'>
                                                    {{-- value="{{
                                                    Carbon\Carbon::parse(old('calibration_date'))->format('j F Y') }}"
                                                    --}}
                                                </div>
                                            </div>
                                            {{-- <div class="col-lg-6">
                                        ...
                                        {{-- <div class="form-group mb-3">
                                            <label for="status" class="form-label text-capitalize">{{ __('status')
                                                }}</label>
