            ...
            <div class="col-12 col-xl-12">
                <div class="px-0 col-12">
                    <div class="border-0 shadow card">
                        <div class="card-body">
                            <h2 class="mb-1 fs-5 fw-bold mb-5">{{ __('Ubah Entri Log Pinjam') }}</h2>
                            <div class="row mb-5">
                                <div class="col">
                                    ...
                                    <form wire:submit='update' method="post">
                                        <div class="form-group mb-3">
                                            <div class="row">
                                                <div class="col-lg-12">
                                                    <div class="form-group mb-3">
                                                        <label for="inventory_id" class="form-label">{{ __('Pilih
                                                            Inventaris') }}</label>
                                                        <div wire:ignore>
                                                            <select name="inventory_id" id="inventory_id"
                                                                class="form-control" wire:model='inventory_id'>
                                                                <option value="">{{ __('Pilih salah satu...') }}
                                                                </option>
                                                                @foreach ($inventory as $inv)
                                                                    <option value="{{ $inv->id }}{{ old('inventory_id', $inv->inventory_id) }}">{{ $inv->device_name }}
                                                                </option>
                                                                @endforeach
                                                            </select>
                                                        </div>
                                                ...
                                                <div class="col-lg-6">
                                                    <div class="form-group mb-3">
                                                        <label for="aksesoris" class="form-label text-capitalize">{{
                                                            __('tanggal') }}</label>
                                                        <input type="date" name="tanggal" id="tanggal"
                                                            class="form-control" wire:model='tanggal'>
                                                    </div>
                                                </div>
                                                <div class="col-lg-6">
                                                    <div class="form-group mb-3">
                                                        <label for="aksesoris" class="form-label text-capitalize">{{
                                                            __('aksesoris') }}</label>
                                                        <input type="text" name="aksesoris" id="aksesoris"
                                                            class="form-control" wire:model='aksesoris'>
                                                    </div>
                                                </div>
                                                <div class="col-lg-6">
                                                    <div class="form-group mb-3">
                                                ...
                                                <div class="col-lg-6">
                                                    <div class="form-group mb-3">
                                                        <label for="kondisi_awal" class="form-label text-capitalize">{{
                                                            __('kondisi awal') }}</label>
                                                ...
                                                <div class="col-lg-6">
                                                    <div class="form-group mb-3">
                                                        <label for="kondisi_akhir" class="form-label text-capitalize">{{
                                                            __('kondisi akhir') }}</label>
                                                ...
                                                <div class="col-lg-6">
                                                    <div class="form-group mb-3">
                                                        <label for="lokasi" class="form-label text-capitalize">{{
                                                            __('lokasi pinjam') }}</label>
                                                        <input type="text" class="form-control"
                                                            wire:model='lokasi_pinjam'>
                                                    </div>
                                                </div>
                                                <div class="col-lg-6">
                                                    <div class="form-group mb-3">
                                                        <label for="pic" class="form-label text-capitalize">{{ __('PIC')
                                                            }}</label>
