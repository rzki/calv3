            ...
            <div class="col-12 col-xl-12">
                <div class="px-0 col-12">
                    <div class="border-0 shadow card">
                        <div class="card-body">
                            <h2 class="mb-1 fs-5 fw-bold mb-5">{{ __('Tambah Entri Log Pinjam') }}</h2>
                            <div class="row mb-5">
                                <div class="col">
                                    ...
                                    <form wire:submit='create' method="post">
                                        <div class="form-group mb-3">
                                            <div class="row">
                                                <div class="col-lg-12">
                                                    <div class="form-group mb-3">
                                                        <label for="inventory_id" class="form-label">{{ __('Pilih Inventaris') }}</label>
                                                        <div wire:ignore>
                                                            <select name="inventory_id" id="inventory_id" class="form-control" wire:model='inventory_id'>
