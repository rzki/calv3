...
{
    public $alat, $namaAlat, $deviceId, $nama, $merk, $tipe, $serial_number, $lokasi, $rumah_sakit, $kalibrasi_terakhir, $status;
    public function mount($deviceId)
    {
        ...
        $this->rumah_sakit = $this->alat->hospital_id;
